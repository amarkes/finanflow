-- Aperfeiçoa a função de auditoria para garantir logs em create/update/delete
-- com fallback seguro de usuário e sempre registrar alterações (mesmo sem diff).
...
BEGIN
  ...
  -- Sempre grava, mesmo que diff fique vazio (pode indicar operações idempotentes)
